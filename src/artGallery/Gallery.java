...
public class Gallery extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "GALLERY", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 3, 18))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel2.setText("GALLERY_ID");

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel3.setText("GALLERY_NAME");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtloc, javax.swing.GroupLayout.DEFAULT_SIZE, 173, Short.MAX_VALUE))
    ...
    private void table_update()
    {
        try {
            ...
            try {
                ...
                pst = con1.prepareStatement("select * from gallery");
                rs = pst.executeQuery();
                ...
                while(rs.next())
                {
                    ...
                    for(int i=1; i<=c; i++)
                    {
                        ...
                        v2.add(rs.getString("G_Location"));
                    }
                    d.addRow(v2);
                }
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        String gallery_name = txtgname.getText();
        ...
        try {
            ...
            pst = con1.prepareStatement("insert into gallery (G_ID, G_Name, G_Location)values(?,?,?)");
            pst.setString(1, gallery_id);
            pst.setString(2, gallery_name);
            ...
            //pst.executeUpdate();
             insert = con1.prepareStatement("select * from gallery where G_ID =?");
                ...
                if(rs.next() == true)
                {
                    ...
                    pst.executeUpdate();
            JOptionPane.showMessageDialog(null,"Galley Details Added");
            table_update();
            txtgid.setText("");
            txtgname.setText("");
            txtloc.setText("");
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        if(DialogResult == JOptionPane.YES_OPTION)
        {
            try {
                 Class.forName("com.mysql.jdbc.Driver");
                 con1 = DriverManager.getConnection("jdbc:mysql://localhost/ArtGallery?useSSL=false","root","shrikrishna17#");
                pst = con1.prepareStatement("delete from gallery where G_ID =?");
                pst.setString(1, gallery_id);
                 pst.executeUpdate();
                JOptionPane.showMessageDialog(null,"Gallery Details Deleted");
                table_update();
                txtgid.setText("");
                txtgname.setText("");
                txtloc.setText("");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        txtgid.setText(d1.getValueAt(seclectIndex, 0).toString());
         txtgname.setText(d1.getValueAt(seclectIndex, 1).toString());
          txtloc.setText(d1.getValueAt(seclectIndex, 2).toString());
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        try {
             Class.forName("com.mysql.jdbc.Driver");
            con1 = DriverManager.getConnection("jdbc:mysql://localhost/ArtGallery?useSSL=false","root","shrikrishna17#");
            pst = con1.prepareStatement("update gallery set G_Name=?, G_Location=? where G_ID=? ");
            pst.setString(1, gallery_name);
            pst.setString(2, location);
            pst.setString(3, gallery_id);
            pst.executeUpdate();
            JOptionPane.showMessageDialog(null,"Gallery DetailsUpdated");
            table_update();
            txtgid.setText("");
            txtgname.setText("");
            txtloc.setText("");
